...
const NAMES = ["DC3D_MAGIC", "DC3D_VERSION", "OP_SET_CAMERA", "OP_DRAW", "OP_IMM_TRIS", "OP_BIND_TEXTURE", "OP_SET_LIGHTS", "OP_DRAW_SKINNED", "OP_SET_FOG", "OP_DRAW_SKIN", "OP_DRAW_SKIN_ANIM", "FMT_POS", "FMT_COLOR", "FMT_NORMAL", "FMT_UV", "FMT_WEIGHTS"];
