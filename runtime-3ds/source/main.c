...
#include "game_dcpak.h" // generated: GAME_DCPAK[] and GAME_DCPAK_LEN (asset pack)
...
int main(int argc, char **argv) {
    ...
    // Expose the game's binary asset pack as __dcpak before eval (the baked asset
    // modules read it at module-eval time). See docs/dcpak-format.md.
    if (GAME_DCPAK_LEN > 0) {
        JSValue dcpak = JS_NewArrayBufferCopy(ctx, GAME_DCPAK, GAME_DCPAK_LEN);
        JS_SetPropertyStr(ctx, global, "__dcpak", dcpak);
    }
