...
export const cartridge: Theme = {
  ...
  tokens: {
    ...
    "--code-string": "#8fdc7a",
    "--code-number": "#e7c178",
    "--code-function": "#79d2ff",
    "--code-class": "#e5c07b",
    "--code-variable": "#ef9aa2",
    "--font-sans": SANS,
    "--font-mono": MONO,
...
export const dmg: Theme = {
  ...
  tokens: {
    ...
    "--code-fg": "#9bbc0f",
    "--code-border": "#306230",
    // Authentic DMG: stay within the 4-shade Game Boy green palette; comments dim,
    // keywords brightest (base.ts also italicizes comments / bolds keywords).
    "--code-comment": "#4f7a2c",
    "--code-keyword": "#9bbc0f",
    "--code-string": "#8bac0f",
    "--code-number": "#8bac0f",
    "--code-function": "#9bbc0f",
    "--code-class": "#8bac0f",
    "--code-variable": "#9bbc0f",
    "--font-sans": SANS,
    "--font-mono": MONO,
    "--font-display": '"Space Grotesk", ' + SANS,
...
export const light: Theme = {
  ...
  tokens: {
    ...
    "--code-fg": "#e6edf3",
    "--code-border": "#23303f",
    // Light theme keeps a dark code block, so a classic dark-bg syntax palette.
    "--code-comment": "#8b949e",
    "--code-keyword": "#c678dd",
    "--code-string": "#98c379",
    "--code-number": "#d19a66",
