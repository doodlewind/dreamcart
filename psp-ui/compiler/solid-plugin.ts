// compiler/solid-plugin.ts — pass-1 babel transform + AST collection.
//
// transformFile(path, src) runs babel-preset-solid {generate:'universal',
// moduleName:<ABSOLUTE src/renderer.ts>} + @babel/preset-typescript over one
...
//     for bake-font.ts).
//
// Lints (throw with a code frame, per DESIGN.md "loud errors"):
